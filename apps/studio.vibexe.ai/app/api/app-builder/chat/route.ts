		...
		if (isGameProject) {
			...
			const pathRewrites = isGame3d
				? new Map([
					...
					// AI creates BootScene/MenuScene instead of GameScene3D — redirect content
					["src/scenes/BootScene.ts", "src/scenes/GameScene3D.ts"],
					["src/scenes/BootScene3D.ts", "src/scenes/GameScene3D.ts"],
					["src/scenes/MenuScene.ts", "src/scenes/GameScene3D.ts"],
					["src/scenes/MenuScene3D.ts", "src/scenes/GameScene3D.ts"],
					["src/scenes/LoadingScene.ts", "src/scenes/GameScene3D.ts"],
					["src/scenes/LoadingScene3D.ts", "src/scenes/GameScene3D.ts"],
					["src/scenes/MainScene.ts", "src/scenes/GameScene3D.ts"],
					["src/scenes/MainScene3D.ts", "src/scenes/GameScene3D.ts"],
