 ...
 * @see apps/studio.vibexe.ai/lib/internal-api/files.ts
 */
...
export async function POST(
	...
	const app = await vibexe.getApp({ appId }).catch(() => null);
	if (!app) {
	...
	await vibexe.uploadFile(file, app.workspaceId, uploading.id, fileName);
