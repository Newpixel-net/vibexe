import { Background } from "@vibexe-internal/workflow-designer-ui";
import { type Workspace, WorkspaceId } from "@vibexe-ai/protocol";
	...
	return (
		<Page
			...
			workspaceSaveAction={async (workspace: Workspace) => {
				...
				await vibexe.updateWorkspace(workspace);
			}}
		/>
	);
}
...
export default async function ({
	...
	if (useNewLanguageModel) {
		vibexe.updateContext({ experimental_contentGenerationNode: true });
	}
