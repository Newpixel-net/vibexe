...
import {
	AppDesignerProvider,
	Editor,
} from "@vibexe-internal/workflow-designer-ui";
import type { Integration } from "@vibexe-ai/vibexe";
import type { Trigger, Workspace } from "@vibexe-ai/protocol";
import { VibexeClientProvider, WorkspaceProvider } from "@vibexe-ai/react";
...
export function Page({
	...
	return (
		<VibexeClientProvider value={client}>
			<AppDesignerProvider
				vibexeClient={client}
