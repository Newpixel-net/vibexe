        ...
        if (_rpHasTextures) {
          ...
          function _rpApplyShaderMaterial() {
            ...
            var _rpFragShader = [
              ...
              "",
              "  // Roughness: skip map sampling for distant terrain (saves 4 texture fetches)",
              "  float r0, r1, r2, r3;",
              "  if (lodNear < 0.99) {",
              ...
              "  }",
              "",
              "  // AO: skip for mid-distance+ terrain (saves 4 texture fetches)",
              "  float ao0 = 1.0, ao1 = 1.0, ao2 = 1.0, ao3 = 1.0;",
              "  if (lodNear < 0.5) {",
              "    ao0 = sampleTerrainR(uAOMap0, vWorldPos, baseUv, N, uTexScale0, uHasAOMap0, 1.0);",
              "    ao1 = sampleTerrainR(uAOMap1, vWorldPos, baseUv, N, uTexScale1, uHasAOMap1, 1.0);",
              "    ao2 = sampleTerrainR(uAOMap2, vWorldPos, baseUv, N, uTexScale2, uHasAOMap2, 1.0);",
              "    ao3 = sampleTerrainR(uAOMap3, vWorldPos, baseUv, N, uTexScale3, uHasAOMap3, 1.0);",
              "  }",
              "",
