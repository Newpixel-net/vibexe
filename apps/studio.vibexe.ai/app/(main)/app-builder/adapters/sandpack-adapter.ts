		...
		try {
			...
			if (assetsKey) {
				...
				const constMap: [string, number | undefined, number, number][] = [
					...
					["CAMERA_OFFSET_Y", gsObj.camera?.offsetY, 3, 100],
					["CAMERA_OFFSET_Z", gsObj.camera?.offsetZ, 3, 100],
					["CAMERA_HEIGHT", gsObj.camera?.offsetY, 3, 100],
					["CAMERA_DISTANCE", gsObj.camera?.offsetZ, 3, 100],
