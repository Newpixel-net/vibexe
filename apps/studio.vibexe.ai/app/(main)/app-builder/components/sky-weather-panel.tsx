...
const WEATHER_PRESETS = [
	...
	{ label: "Fair", icon: "🌤", clouds: { coverage: 0.2, brightness: 1.0 }, fog: { enabled: true, density: 0.001, autoColor: true }, precipitation: { type: "none", intensity: 0 }, lightning: { enabled: false }, sky: { exposure: 1.2, sunIntensity: 22 } },
	{ label: "Partly Cloudy", icon: "⛅", clouds: { coverage: 0.45, brightness: 0.95 }, fog: { enabled: true, density: 0.0015, autoColor: true }, precipitation: { type: "none", intensity: 0 }, lightning: { enabled: false }, sky: { exposure: 1.15, sunIntensity: 20 } },
	{ label: "Cloudy", icon: "☁️", clouds: { coverage: 0.8, brightness: 0.75 }, fog: { enabled: true, density: 0.002, autoColor: true }, precipitation: { type: "none", intensity: 0 }, lightning: { enabled: false }, sky: { exposure: 0.95, sunIntensity: 16 } },
	{ label: "Overcast", icon: "🌥", clouds: { coverage: 0.95, brightness: 0.45 }, fog: { enabled: true, density: 0.003, autoColor: true }, precipitation: { type: "none", intensity: 0 }, lightning: { enabled: false }, sky: { exposure: 0.7, sunIntensity: 12 } },
	{ label: "Rainy", icon: "🌧", clouds: { coverage: 0.92, brightness: 0.4 }, fog: { enabled: true, density: 0.004, autoColor: true }, precipitation: { type: "rain", intensity: 0.85, windStrength: 0.5 }, lightning: { enabled: false }, sky: { exposure: 0.6, sunIntensity: 10 } },
	{ label: "Snowy", icon: "🌨", clouds: { coverage: 0.88, brightness: 0.55 }, fog: { enabled: true, density: 0.003, autoColor: true }, precipitation: { type: "snow", intensity: 0.85, windStrength: 0.25 }, lightning: { enabled: false }, sky: { exposure: 0.75, sunIntensity: 14 } },
	{ label: "Foggy", icon: "🌫", clouds: { coverage: 0.6, brightness: 0.5 }, fog: { enabled: true, density: 0.008, autoColor: true }, precipitation: { type: "none", intensity: 0 }, lightning: { enabled: false }, sky: { exposure: 0.75, sunIntensity: 14 } },
	{ label: "Stormy", icon: "⛈", clouds: { coverage: 0.98, brightness: 0.25, density: 1.0 }, fog: { enabled: true, density: 0.005, autoColor: true }, precipitation: { type: "rain", intensity: 0.95, windStrength: 0.8 }, lightning: { enabled: true, frequency: 0.2 }, sky: { exposure: 0.5, sunIntensity: 6 } },
] as const;
