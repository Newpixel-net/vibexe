			...
			<div className="max-w-3xl mx-auto space-y-6">
				...
				<div className="flex items-center justify-between">
					...
					<button
						...
						disabled={saving}
						className="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-gradient-to-r from-violet-500/80 to-cyan-500/80 text-white hover:from-violet-500 hover:to-cyan-500 disabled:opacity-50 transition-colors"
					>
						{saving ? (
				...
				{/* Empty State */}
				{agents.length === 0 && (
					<div className="rounded-xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-sm p-12 text-center">
						...
						<button
							...
							onClick={handleCreate}
							disabled={saving}
							className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-gradient-to-r from-violet-500/80 to-cyan-500/80 text-white hover:from-violet-500 hover:to-cyan-500 disabled:opacity-50 transition-colors"
						>
							<Plus className="h-4 w-4" />
							Create Agent
						</button>
				...
				{agents.map((agent) => {
					...
					return (
						<div
							key={agent.dbId}
							className="rounded-xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-sm overflow-hidden"
						>
							{/* Agent Row */}
								...
								>
									...
									<div className="min-w-0 flex-1">
										<div className="flex items-center gap-2">
											...
											<span className="px-1.5 py-0.5 rounded text-[10px] font-medium bg-white/[0.06] text-white/40">
...
function AgentEditor({ agent, onSave, onDelete, saving }: AgentEditorProps) {
	...
	return (
		<div className="border-t border-white/[0.06] p-4 space-y-4 bg-white/[0.03]">
			{/* Name */}
			<div>
				...
				<input
					...
					className="w-full px-3 py-2 text-sm bg-white/[0.06] border border-white/[0.1] rounded-lg focus:outline-none focus:ring-1 focus:ring-violet-500/30"
			...
			<div className="flex items-center justify-between">
				...
				<button
					...
					className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
						enabled ? "bg-gradient-to-r from-violet-500 to-cyan-500" : "bg-white/[0.08]"
					}`}
				>
					<span
						className={`inline-block h-4 w-4 transform rounded-full bg-white/[0.02] transition-transform ${
			...
			<div>
				...
				<textarea
					...
					rows={6}
					className="w-full px-3 py-2 text-sm bg-white/[0.06] border border-white/[0.1] rounded-lg focus:outline-none focus:ring-1 focus:ring-violet-500/30 resize-y font-mono"
