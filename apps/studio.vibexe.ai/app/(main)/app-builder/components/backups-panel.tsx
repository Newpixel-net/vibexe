			...
			{showGuide && (
				<div className="rounded-xl border border-violet-500/15 bg-violet-500/[0.03] p-4 space-y-3">
					<div className="flex items-start justify-between">
						<h3 className="text-sm font-medium text-violet-400">How Backups Work</h3>
						<button
							type="button"
					...
					<div className="space-y-2.5 text-xs text-white/40">
						<div className="flex items-start gap-2">
							...
							<span><strong className="text-white/60">Automated daily backups</strong> run every 24 hours for each active database. No action needed &mdash; your data is protected automatically.</span>
						</div>
						<div className="flex items-start gap-2">
							<Plus className="h-3.5 w-3.5 text-violet-400 mt-0.5 shrink-0" />
							<span><strong className="text-white/60">Manual backups</strong> can be created anytime with the &quot;Create Backup&quot; button. Use this before making risky changes.</span>
						</div>
						<div className="flex items-start gap-2">
							<Shield className="h-3.5 w-3.5 text-emerald-400 mt-0.5 shrink-0" />
							<span><strong className="text-white/60">Pre-deploy & pre-promote</strong> backups are created automatically before schema changes and environment promotions.</span>
						</div>
						<div className="flex items-start gap-2">
							<RotateCcw className="h-3.5 w-3.5 text-amber-400 mt-0.5 shrink-0" />
							<span><strong className="text-white/60">Restore</strong> rolls your database back to a previous snapshot. A safety backup is taken before restoring, so you can undo a restore if needed.</span>
						</div>
						<div className="flex items-start gap-2">
							<Zap className="h-3.5 w-3.5 text-white/30 mt-0.5 shrink-0" />
							<span><strong className="text-white/60">Retention:</strong> Backups are kept for 30 days by default. Expired backups are automatically cleaned up.</span>
						</div>
					</div>
					<div className="border-t border-white/[0.06] pt-2.5">
						<div className="flex flex-wrap gap-2 text-xs">
							<span className="px-2 py-0.5 rounded-full bg-blue-500/20 text-blue-400">scheduled</span>
							<span className="text-white/30">Daily automatic</span>
							<span className="px-2 py-0.5 rounded-full bg-violet-500/20 text-violet-400">manual</span>
							<span className="text-white/30">You created it</span>
							<span className="px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-400">pre-deploy</span>
							<span className="text-white/30">Before schema changes</span>
							<span className="px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400">pre-promote</span>
							<span className="text-white/30">Before environment promotion</span>
						</div>
					</div>
				</div>
			)}
