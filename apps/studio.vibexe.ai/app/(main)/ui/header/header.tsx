...
import { VibexeLogo } from "@/components/vibexe-logo";
		...
		<header className="h-[48px] shrink-0 border-b border-border flex items-center justify-between px-4 bg-background">
			...
			<div className="flex items-center gap-[3px]">
				<Link href="/" aria-label="Go to home" className="group">
					<VibexeLogo className="h-[24px] w-auto fill-inverse group-hover:fill-primary-100 transition-colors" />
				</Link>
			...
			<div className="flex items-center gap-4">
				...
				<Link
					href="https://docs.vibexe.ai/en/releases/release-notes"
					target="_blank"
					rel="noopener"
