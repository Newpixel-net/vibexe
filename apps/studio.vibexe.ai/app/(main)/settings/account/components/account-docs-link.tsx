...
const DOCS_LINKS = {
	"/settings/account": {
		href: "https://docs.vibexe.ai/en/guides/settings/account/overview",
		label: "About Account Overview",
	},
	"/settings/account/general": {
		href: "https://docs.vibexe.ai/en/guides/settings/account/general",
		label: "About Account Settings",
	},
	"/settings/account/authentication": {
		href: "https://docs.vibexe.ai/en/guides/settings/account/authentication",
