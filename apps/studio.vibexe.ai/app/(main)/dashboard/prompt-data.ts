...
export const PROJECT_TYPES: ProjectType[] = [
	...
	},
	{
		...
		placeholders: [
			...
			"Build me a 2048 puzzle game with smooth animations...",
			"Build me a Snake game with progressive difficulty and leaderboard...",
		],
		suggestions: [
			{ label: "Platformer", prompt: "Build me a Super Mario-style platformer with multiple levels, enemies to stomp, coins to collect, and a flagpole finish" },
			{ label: "Tetris Clone", prompt: "Build me a Tetris game with piece rotation, line clearing, increasing speed, score tracking, and next piece preview" },
			{ label: "Space Shooter", prompt: "Build me a space shooter with player ship, enemy waves, power-ups, boss fights, and explosion effects" },
			{ label: "Puzzle Game", prompt: "Build me a 2048-style sliding puzzle game with smooth tile animations, score tracking, and best score persistence" },
			{ label: "Arcade Snake", prompt: "Build me a Snake game with growing snake, food spawning, wall collision, speed increase, and high score board" },
		],
	},
	{
		id: "website",
...
export const CATEGORY_TAGS: CategoryTag[] = [
	...
	{ id: "social", label: "Social", forTypes: ["app", "mobile", "game"] },
