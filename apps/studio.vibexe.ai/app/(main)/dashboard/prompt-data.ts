...
export const PROJECT_TYPES: ProjectType[] = [
	...
	},
	{
		...
		icon: "Gamepad2",
		placeholders: [
			"Build me a Super Mario-style platformer with enemies and power-ups...",
			"Build me a Tetris clone with increasing speed and high scores...",
			"Build me a space shooter with waves of enemies and boss fights...",
			"Build me a chess game with AI opponent and move validation...",
			"Build me a tower defense game with upgradeable towers and waves...",
		],
		suggestions: [
			{ label: "Platformer", prompt: "Build me a Super Mario-style platformer with multiple levels, enemies to stomp, coins to collect, and a flagpole finish. Desktop, keyboard controls" },
			{ label: "Space Shooter", prompt: "Build me a space shooter with player ship, enemy waves, power-ups, boss fights, and explosion effects. Desktop, keyboard/mouse" },
			{ label: "Tower Defense", prompt: "Build me a tower defense game with placeable towers, enemy waves, upgrade paths, and a map editor. Desktop, mouse controls" },
			{ label: "Chess Game", prompt: "Build me a chess game with legal move validation, AI opponent, move history, and captured pieces display. Desktop layout" },
			{ label: "Racing Game", prompt: "Build me a top-down racing game with tracks, lap timing, obstacles, and a minimap. Desktop, arrow key controls" },
		],
	},
	{
		id: "game-mobile",
		...
		icon: "Gamepad2",
		placeholders: [
			"Build me a Flappy Bird-style tap game with pipe obstacles...",
			"Build me a 2048 puzzle with smooth swipe controls...",
			"Build me an idle clicker game with upgrades and prestige...",
			"Build me a vertical endless runner with swipe controls...",
			"Build me a tap timing rhythm game with visual feedback...",
		],
		suggestions: [
			{ label: "Flappy Clone", prompt: "Build me a Flappy Bird mobile game with tap-to-fly, pipe obstacles, score counter, high score. Portrait, touch only, one-thumb" },
			{ label: "2048 Puzzle", prompt: "Build me a 2048 mobile puzzle with swipe controls, tile animations, score tracking, best score. Portrait layout" },
			{ label: "Idle Clicker", prompt: "Build me an idle clicker mobile game with tap-to-earn, upgrade shop, offline progress. Portrait, large tap target" },
			{ label: "Endless Runner", prompt: "Build me a vertical endless runner mobile game with swipe-to-dodge, coins, increasing speed. Portrait" },
			{ label: "Tap Rhythm", prompt: "Build me a tap timing rhythm mobile game with targets, accuracy scoring, combo multiplier. Portrait" },
		],
	},
	{
		id: "website",
...
export const CATEGORY_TAGS: CategoryTag[] = [
	...
	{ id: "social", label: "Social", forTypes: ["app", "mobile", "game", "game-mobile"] },
