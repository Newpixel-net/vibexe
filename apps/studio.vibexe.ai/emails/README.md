...
```bash
pnpm -F studio.vibexe.ai email:dev
```
...
- Store shared images in `apps/studio.vibexe.ai/public/emails`. These files are served from `/emails/*` in production emails.
...
```bash
pnpm -F studio.vibexe.ai email:export
```
...
**Social Media Links:**
- GitHub: `https://github.com/Newpixel-net/vibexe`
- LinkedIn: `https://www.linkedin.com/showcase/vibexe-ai/`
- Facebook: `https://www.facebook.com/VibexeAI/`
- X: `https://x.com/Vibexes_AI`
- Instagram: `https://www.instagram.com/vibexe_de_ai`
- YouTube: `https://www.youtube.com/@Vibexe_AI`
...
1. Create a new template file in `apps/studio.vibexe.ai/emails/marketing/`
