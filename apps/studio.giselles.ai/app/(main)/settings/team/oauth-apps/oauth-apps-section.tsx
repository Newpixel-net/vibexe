...
const PROVIDER_INFO: Record<string, { label: string; description: string; docsUrl: string; color: string; domain: string }> = {
	...
	datadog: {
		...
		docsUrl: "https://app.datadoghq.com/organization-settings/oauth-applications",
		color: "#632CA6",
	...
	plaid: {
		label: "Plaid",
		description: "Financial data APIs and banking connections",
	...
	supabase: {
		label: "Supabase",
		description: "Open source backend and database platform",
