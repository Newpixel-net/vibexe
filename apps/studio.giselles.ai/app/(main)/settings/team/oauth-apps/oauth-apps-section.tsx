...
const PROVIDER_INFO: Record<string, { label: string; description: string; docsUrl: string; color: string; domain: string }> = {
	...
	// --- 23 More Providers (to reach 100) ---
	snapchat: {
		label: "Snapchat",
		description: "Snap Ads, audience management, and social media",
	...
	cloudflare: {
		label: "Cloudflare",
		description: "CDN, DNS, security, and web infrastructure",
	...
	sentry: {
		...
		docsUrl: "https://sentry.io/settings/developer-settings/",
		color: "#362D59",
		domain: "sentry.io",
	},
	mixpanel: {
	...
	segment: {
		label: "Segment",
		description: "Customer data platform and integrations",
	...
	brevo: {
		label: "Brevo",
		description: "Email marketing, SMS, and CRM",
	...
	freshsales: {
		label: "Freshsales",
		description: "Sales CRM and lead management",
	...
	lever: {
		label: "Lever",
		description: "Recruiting and talent acquisition",
	...
	front: {
		label: "Front",
		description: "Shared inbox and team communication",
	...
	servicenow: {
		label: "ServiceNow",
		description: "IT service management and workflows",
	...
	vercel: {
		label: "Vercel",
		description: "Deployment platform and serverless hosting",
	...
	line: {
		label: "LINE",
		description: "Messaging, social platform, and bot APIs",
		docsUrl: "https://developers.line.biz/console/",
		color: "#00C300",
		domain: "line.me",
	},
	// --- Missing OAuth2 Providers ---
	"help-scout": {
		label: "Help Scout",
		description: "Help desk, shared inbox, and customer support",
	...
	meistertask: {
		label: "MeisterTask",
		description: "Task and project management boards",
		docsUrl: "https://developers.meister.co/",
		color: "#00BFA5",
	...
	podio: {
		label: "Podio",
		description: "Workspace collaboration and project management",
	...
	teamleader: {
		label: "Teamleader",
		description: "CRM, project management, and invoicing",
	...
	"campaign-monitor": {
		...
		docsUrl: "https://www.campaignmonitor.com/api/getting-started/",
		color: "#509CF6",
		domain: "campaignmonitor.com",
	},
	bigcommerce: {
		label: "BigCommerce",
		description: "E-commerce platform and online stores",
	...
	"http-oauth2": {
		label: "HTTP OAuth2",
		description: "Generic HTTP requests with OAuth2 authentication",
	...
	zeplin: {
		label: "Zeplin",
		description: "Design handoff and collaboration for developers",
	...
	bexio: {
		label: "Bexio",
		description: "Swiss business software and accounting",
	...
	zuora: {
		...
		docsUrl: "https://developer.zuora.com/",
		color: "#0F2B46",
		domain: "zuora.com",
	},
	netsuite: {
		label: "NetSuite",
		description: "Oracle ERP, accounting, and business management",
		docsUrl: "https://system.netsuite.com/app/login/",
		color: "#00607B",
		domain: "netsuite.com",
	},
	splitwise: {
		label: "Splitwise",
		description: "Shared expense tracking and bill splitting",
	...
	"sap-ariba": {
		...
		docsUrl: "https://developer.sap.com/topics/ariba.html",
		color: "#0070F2",
		domain: "ariba.com",
	},
	formstack: {
		label: "Formstack",
		description: "Online forms, workflows, and document generation",
		docsUrl: "https://developers.formstack.com/",
		color: "#21B573",
	...
	truelayer: {
		label: "TrueLayer",
		description: "Open banking payments and data APIs",
		docsUrl: "https://truelayer.com/docs/",
		color: "#0038FF",
