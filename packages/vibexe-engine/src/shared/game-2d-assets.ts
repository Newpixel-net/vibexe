...
export function buildAssetReferencePrompt(): string {
	const lines: string[] = [
		...
		"- **trees**: round_tree, pine_tree, palm_tree, dead_tree",
		"- **bushes**: bush_green, bush_flower",
		"- **clouds**: cloud_puffy, cloud_small",
		"- **collectibles**: coin_gold, gem_red, gem_blue, star, heart",
		"- **props**: crate, barrel, rock, fence, sign_post",
		"- **backgrounds**: hill_green, hill_snow, mountain_rock",
		"",
