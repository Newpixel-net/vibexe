...
import { githubTools, octokit } from "@vibexe-ai/github-tool";
import {
	Capability,
	hasCapability,
	languageModels,
...
import { transformVibexeLanguageModelToAiSdkLanguageModelCallOptions } from "./v2/language-model";
...
function generateContentV2({
	...
	return useGenerationExecutor({
		...
		execute: async ({
			...
			const callOptions =
				transformVibexeLanguageModelToAiSdkLanguageModelCallOptions(
					resolvedContent,
				);
