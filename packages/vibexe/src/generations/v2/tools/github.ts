import type { Octokit } from "@vibexe-ai/github-tool";
import type { Tool } from "@vibexe-ai/language-model-registry";
import { hasSchema } from "@vibexe-ai/language-model-registry";
...
export function createGitHubTools({
	...
	for (const toolDef of toolDefs) {
		...
		toolSet[`github-api_${toolDef.name}`] = defineTool({
