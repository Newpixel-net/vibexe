import { hasTierAccess, languageModels } from "@vibexe-ai/language-model";
import {
	type AiAgentNode,
...
export async function handleAgentTimeConsumption(args: {
	...
	onConsumeAgentTime?: NonNullable<VibexeContext["onConsumeAgentTime"]>;
}) {
...
export async function checkUsageLimits(args: {
	workspaceId: WorkspaceId;
	generation: Generation;
	fetchUsageLimitsFn?: NonNullable<VibexeContext["fetchUsageLimitsFn"]>;
