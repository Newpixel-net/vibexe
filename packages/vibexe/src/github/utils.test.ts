...
describe("parseGitHubUrl", () => {
	...
	test("should parse issue URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/Newpixel-net/vibexe/issues/9",
		);
	...
	test("should parse issue comment URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/Newpixel-net/vibexe/issues/9#issuecomment-2708745880",
		);
		expect(result).toEqual({
			owner: "vibexe-ai",
			repo: "vibexe",
	...
	test("should parse pull request URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/Newpixel-net/vibexe/pull/403",
		);
		expect(result).toEqual({
			owner: "vibexe-ai",
			repo: "vibexe",
	...
	test("should parse pull request review comment URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/Newpixel-net/vibexe/pull/403#discussion_r1984371481",
		);
		expect(result).toEqual({
			owner: "vibexe-ai",
			repo: "vibexe",
	...
	test("should parse release URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/Newpixel-net/vibexe/releases/tag/studio.vibexe.ai%400.7.0",
		);
		expect(result).toEqual({
			owner: "vibexe-ai",
			repo: "vibexe",
			type: "release",
			tagName: "studio.vibexe.ai@0.7.0",
		});
	});
	...
	test("should parse discussion URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/Newpixel-net/vibexe/discussions/385",
		);
		expect(result).toEqual({
			owner: "vibexe-ai",
			repo: "vibexe",
	...
	test("should parse discussion comment URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/Newpixel-net/vibexe/discussions/336#discussioncomment-12181977",
		);
		expect(result).toEqual({
			owner: "vibexe-ai",
			repo: "vibexe",
	...
	test("should parse tree URL with branch and path", () => {
		const result = parseGitHubUrl(
			"https://github.com/Newpixel-net/vibexe/tree/main/apps/playground",
		);
		expect(result).toEqual({
			owner: "vibexe-ai",
			repo: "vibexe",
	...
	test("should parse tree URL with commit hash and path", () => {
		const result = parseGitHubUrl(
			"https://github.com/Newpixel-net/vibexe/tree/0e4b541c3296c67adb279fd2e4805113e79f972a/apps/playground",
		);
		expect(result).toEqual({
			owner: "vibexe-ai",
			repo: "vibexe",
	...
	test("should parse commit URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/Newpixel-net/vibexe/commit/0e4b541c3296c67adb279fd2e4805113e79f972a",
		);
		expect(result).toEqual({
			owner: "vibexe-ai",
			repo: "vibexe",
	...
	test("should handle repository root URL", () => {
		const result = parseGitHubUrl("https://github.com/Newpixel-net/vibexe");
		expect(result).toEqual({
			owner: "vibexe-ai",
			repo: "vibexe",
			type: "tree",
...
test("invalid command format returns null", () => {
	...
	expect(parseCommand("vibexe hello")).toBe(null);
});

test("command with multiple spaces", () => {
	expect(parseCommand("/vibexe    hello   some content")).toStrictEqual({
		callsign: "vibexe",
...
test("command with no empty line after command", () => {
	expect(parseCommand("/vibexe hello content")).toStrictEqual({
		callsign: "vibexe",
