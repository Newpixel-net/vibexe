...
const BUILT_IN_NODES: Array<{
	...
	{ name: "Aggregate", description: "Aggregate data by groups", keywords: ["aggregate", "group", "sum", "count", "avg", "average"], icon: <HashIcon className="w-3 h-3" />, section: "transform", factory: createAggregateNode },
	{ name: "Summarize", description: "Create summary statistics", keywords: ["summarize", "summary", "stats", "statistics", "median", "mean"], icon: <BarChart3Icon className="w-3 h-3" />, section: "transform", factory: createSummarizeNode },
	{ name: "Limit", description: "Limit number of items", keywords: ["limit", "top", "first", "last", "max items", "take"], icon: <ListEndIcon className="w-3 h-3" />, section: "transform", factory: createLimitNode },
	{ name: "Remove Duplicates", description: "Remove duplicate items", keywords: ["deduplicate", "unique", "distinct", "duplicates", "remove duplicates"], icon: <CopyMinusIcon className="w-3 h-3" />, section: "transform", factory: createRemoveDuplicatesNode },
	{ name: "Rename Keys", description: "Rename object keys", keywords: ["rename", "keys", "fields", "columns", "mapping"], icon: <PencilIcon className="w-3 h-3" />, section: "transform", factory: createRenameKeysNode },
	{ name: "Split Out", description: "Split nested arrays into items", keywords: ["split", "expand", "flatten", "unpack", "explode"], icon: <SplitIcon className="w-3 h-3" />, section: "transform", factory: createSplitOutNode },
	{ name: "Compare Datasets", description: "Compare two datasets", keywords: ["compare", "diff", "difference", "merge", "match", "datasets"], icon: <GitCompareIcon className="w-3 h-3" />, section: "transform", factory: createCompareDatasetsNode },
];
