...
export function LanguageModelMegaTooltip({
	userTier,
}: {
	userTier: LanguageModelTier;
}) {
	const hoveredLanguageModel = useLanguageModelV2ToggleGroupStore(
		(s) => s.hover && getEntry(s.hover),
	);
	return (
		<>
			<div
			...
			{hoveredLanguageModel &&
				!hasTierAccess(userTier, hoveredLanguageModel.requiredTier) && (
					<div
						role="tooltip"
					...
					<div className="px-[16px] py-[16px] flex flex-col gap-[16px]">
						<div className="flex items-start gap-[16px]">
							<div className="flex items-center shrink-0">
								<ProviderIcon
									modelId={hoveredLanguageModel.id}
									className="size-[24px]"
								/>
							</div>
						...
						{/*<div className="flex flex-wrap gap-x-[8px] gap-y-[8px]">
							{hasCapability(
								...
								<CapabilityIcon
									icon={
										<GenerateTextIcon data-icon className="w-[16px] h-[16px]" />
									}
								>
									Generate Text
								</CapabilityIcon>
							...
							{hasCapability(
								...
								<CapabilityIcon
									icon={<DocumentIcon className="w-[16px] h-[16px]" />}
								>
									Input PDF
								</CapabilityIcon>
							)}
							{hasCapability(
								...
								<CapabilityIcon
									icon={<PictureIcon className="w-[16px] h-[16px]" />}
								>
									Input Image
								</CapabilityIcon>
							)}
							{hasCapability(
								...
								<CapabilityIcon
									icon={<SearchIcon className="w-[16px] h-[16px]" />}
								>
									Web Search
								</CapabilityIcon>
							)}
							...
							{hasCapability(
								...
								<>
									...
									<CapabilityIcon
										icon={<AudioIcon className="w-[16px] h-[16px]" />}
									>
										Input Audio
									</CapabilityIcon>
									<CapabilityIcon
										icon={<VideoIcon className="w-[16px] h-[16px]" />}
									>
										Input Video
									</CapabilityIcon>
								</>
							...
							{hasCapability(
								...
								<CapabilityIcon
									icon={<PictureIcon data-icon className="w-[16px] h-[16px]" />}
								>
